export const profile = {
  ...
  whatsapp: "https://wa.me/+8801946282670",
  headline:
...
export const experiences = [
  {
    ...
    tags: ["Next.js", "React", "Responsive UI", "Design Systems", "SCORM"]
  },
  {
    id: "02",
    company: "NerdLab",
    ...
    tags: ["Next.js", "React", "LLM APIs", "Node.js", "Flask", "Streamlit"]
  },
  {
    id: "03",
    company: "BCSIR",
    ...
    tags: ["Python", "TensorFlow", "Time Series", "LSTM", "ARIMA", "Research"]
  },
  {
    id: "04",
    ...
    tags: [".NET", "C#", "Enterprise Architecture", "Debugging"]
  }
];

export const skills = {
  languages: ["Python", "JavaScript", "Java", "C", "C++"],
  tools: ["Git & GitHub", "Swagger", "Figma", "Storybook"],
...
export const proof = [
  {
    metric: "04+",
    label: "Organizations",
    desc: "Worked with agencies, international researchers, and enterprise startups."
  },
  {
    metric: "500K+",
    label: "AQI Data Points",
    desc: "Curated and modeled large-scale time-series records for environmental research."
  },
  {
    metric: "2021-25",
    label: "CSE Degree",
    desc: "Graduated with honors from BRAC University, specializing in software systems."
  },
  {
    metric: "Full-Stack",
    label: "AI Experience",
    desc: "Shipped conversational tools, ML predictors, and standard web products."
  }
];
